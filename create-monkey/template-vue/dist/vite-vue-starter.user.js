...
(function(vue) {
  'use strict';
	...
	_css(" .read-the-docs[data-v-0ba26eba]{color:#888}.logo[data-v-e1becb04]{will-change:filter;height:6em;padding:1.5em}.logo[data-v-e1becb04]:hover{filter:drop-shadow(0 0 2em #646cffaa)}.logo.vue[data-v-e1becb04]:hover{filter:drop-shadow(0 0 2em #42b883aa)}\n/*$vite$:1*/ ");
	...
	var HelloWorld_default = _plugin_vue_export_helper_default({
		__name: "HelloWorld",
		props: { msg: String },
		setup(__props) {
	...
	var _hoisted_4 = ["src"];
	(0, vue.createApp)(_plugin_vue_export_helper_default({
		__name: "App",
		setup(__props) {
			return (_ctx, _cache) => {
	...
	}, [["__scopeId", "data-v-e1becb04"]])).mount((() => {
