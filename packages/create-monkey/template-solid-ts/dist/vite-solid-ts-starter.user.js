...
(function () {
  ...
  const _tmpl$ = /* @__PURE__ */ template(`<div><header><img alt="logo"><p>Edit <code>src/App.tsx</code> and save to reload.</p><a href="https://github.com/solidjs/solid" target="_blank" rel="noopener noreferrer">Learn Solid`);
  const App = () => {
    return (() => {
