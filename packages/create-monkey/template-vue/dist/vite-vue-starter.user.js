...
(function (vue) {
  ...
  importCSS(" .read-the-docs[data-v-0ba26eba]{color:#888}.logo[data-v-e1becb04]{height:6em;padding:1.5em;will-change:filter}.logo[data-v-e1becb04]:hover{filter:drop-shadow(0 0 2em #646cffaa)}.logo.vue[data-v-e1becb04]:hover{filter:drop-shadow(0 0 2em #42b883aa)} ");
  ...
  const HelloWorld = _export_sfc(_sfc_main$1, [["__scopeId", "data-v-0ba26eba"]]);
  ...
  const App = _export_sfc(_sfc_main, [["__scopeId", "data-v-e1becb04"]]);
