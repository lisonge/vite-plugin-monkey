...
System.register("./__entry.js", ['vue'], (function (exports, module) {
  ...
  return {
    ...
    execute: (async function () {
      ...
      if (location.href) {
        (await __vitePreload(() => module.import('./chunk-a4de7bed-27053969.js'), void 0 )).out();
      }
      console.log({ svgUrl2 });
